...
void AppController::run() {
    ...
    // TODO:後で消す
    string str = "";
    const char* test = ServerSendDataBuilder::getInstance().buildPostData(ServerConstData::DATA_TYPE_LITERAL, str);
    // 
